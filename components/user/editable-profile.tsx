...
//                                             <p className="font-semibold capitalize">{talent.experience_level}</p>
//                                         </Card>
//                                     )}
//                                     {talent.years_of_experience && (
//                                         <Card className="p-4">
//                                             <p className="text-xs text-muted-foreground mb-2">Years</p>
//                                             <p className="font-semibold">{talent.years_of_experience}+</p>
//                                         </Card>
//                                     )}
//                                     {talent.availability_status && (
//                                         <Card className="p-4">
//                                             <p className="text-xs text-muted-foreground mb-2">Availability</p>
//                                             <p className="font-semibold capitalize">{talent.availability_status}</p>
//                                         </Card>
//                                     )}
//                                     {talent.currency && (
//                                         <Card className="p-4">
//                                             <p className="text-xs text-muted-foreground mb-2">Currency</p>
//                                             <p className="font-semibold">{talent.currency}</p>
//                                         </Card>
//                                     )}
//                                 </div>

//                                 {/* Rates */}
//                                 {(talent.rate_per_video || talent.rate_per_live || talent.rate_per_post) && (
//                                     <div>
//                                         <h3 className="font-semibold mb-3">Rates</h3>
//                                         <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
//                                             {talent.rate_per_video && (
...
//                                 {(talent.categories?.length > 0 || talent.specializations?.length > 0) && (
//                                     <div>
...
//                                 {(talent.portfolio_description || talent.achievements) && (
//                                     <div className="space-y-4">
//                                         {talent.portfolio_description && (
//                                             <div>
//                                                 <h3 className="font-semibold mb-2">Portfolio</h3>
//                                                 <p className="text-muted-foreground leading-relaxed">{talent.portfolio_description}</p>
//                                             </div>
//                                         )}
//                                         {talent.achievements && (
//                                             <div>
//                                                 <h3 className="font-semibold mb-2">Achievements</h3>
//                                                 <p className="text-muted-foreground leading-relaxed">{talent.achievements}</p>
//                                             </div>
//                                         )}
//                                     </div>
//                                 )}
