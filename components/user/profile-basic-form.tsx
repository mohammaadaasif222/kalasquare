  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
        <div className="space-y-1">
          <Label htmlFor="cintaId" className="text-xs sm:text-sm">
            Cinata ID
          </Label>
          <Input
            id="cintaId"
        ...
        <div className="space-y-1">
          ...
          <Input id="dob" name="dob" type="date" value={formData.dob} onChange={handleChange} className="text-sm h-9" />
        </div>
        <div className="space-y-1 col-span-2 lg:col-span-1">
          ...
          <select
            ...
            value={formData.gender}
            onChange={handleChange}
            className="w-full px-2 py-2 text-sm border border-input rounded-md bg-background text-foreground h-9"
          >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3">
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              onChange={handleChange}
              disabled={!formData.location_state}
              className="w-full px-2 py-2 text-sm border border-input rounded-md bg-background text-foreground h-9 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <option value="">Select</option>
              {availableCities.map((city) => (
                <option key={city} value={city}>
          ...
          <div className="space-y-1">
            <Label htmlFor="pin_code" className="text-xs sm:text-sm">
              Pin Code
            </Label>
            <Input
              id="pin_code"
      ...
      <div className="grid grid-cols-2 gap-2 sm:gap-3">
        ...
        <div className="space-y-1">
          <Label htmlFor="highest_education" className="text-xs sm:text-sm">
            Education
          </Label>
          <Input
            id="highest_education"
      ...
      <div className="flex gap-2 pt-4 border-t">
        <Button type="submit" disabled={isLoading} className="gap-2 flex-1 h-9 text-sm">
