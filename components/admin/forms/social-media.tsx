...
import { X, Star, Trash2, Edit, Plus, AlertCircle, CheckCircle2, XCircle, ExternalLink } from "lucide-react"
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-100">
                  {accounts.map((account: any) => {
                    ...
                    return (
                      <tr key={account.id} className="hover:bg-gradient-to-r hover:from-indigo-50/50 hover:to-blue-50/50 transition-all duration-150">
