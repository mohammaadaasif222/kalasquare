            ...
            >
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className={`px-3 py-1 rounded-full text-xs font-medium ${getTypeColor(sample.type)}`}>
                    {sample.type}
                  </span>
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-medium border ${getStatusColor(sample.status)}`}
                  >
                    {sample.status}
                  </span>
                </div>
                ...
                {sample.url && (
                  <div className="mb-4">
                    ...
                    {isImageUrl(sample.url) && (
                      <img src={sample.url} alt={sample.title} className="w-full h-48 object-cover rounded-lg" />
                    )}
